...
themes below. Currently publishing **1 S-tier** and **279 A-tier** papers.
...
| Metric                   | Value                                   |
| ------------------------ | --------------------------------------- |
| Relevant papers screened | 2060                                    |
| S-tier (published)       | 1                                       |
| A-tier (published)       | 279                                     |
| Sub-domains              | 13                                      |
...
Clusters auto-detected from the paper co-occurrence graph: large language model · multi agent system · retrieval augmented generation; reinforcement learning · transaction cost · stochastic control; neural network · deep learning · option pricing; transformer · regime shift · tail risk; machine learning · portfolio optimization · interpretability; limit order book · diffusion model · market making; portfolio optimization · risk management · mean variance optimization; graph neural network · systemic risk · decentralized finance.
