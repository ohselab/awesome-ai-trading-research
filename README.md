...
themes below. Currently publishing **2 S-tier** and **210 A-tier** papers.
...
| Metric                   | Value                                   |
| ------------------------ | --------------------------------------- |
| Relevant papers screened | 1665                                    |
| S-tier (published)       | 2                                       |
| A-tier (published)       | 210                                     |
| Sub-domains              | 13                                      |
...
Clusters auto-detected from the paper co-occurrence graph: large language model · portfolio optimization · multi agent system; reinforcement learning · deep reinforcement learning · dynamic programming; neural network · option pricing · deep learning; transformer · regime shift · lstm; machine learning · interpretability · portfolio construction; portfolio optimization · risk management · mean variance optimization; limit order book · volatility · order flow; stochastic control · market making · liquidity provision.
